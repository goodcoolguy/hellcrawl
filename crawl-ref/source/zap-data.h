...

{
    ...
    "bolt of fire",
    200,
    new calcdice_calculator<6, 14, 2, 3>,
...

{
    ...
    "fireball",
    200,
    new calcdice_calculator<3, 9, 1, 2>,
...

{
    ...
    200,
    new calcdice_calculator<4, 12, 3, 5>,
    new tohit_calculator<8, 1, 20>,
...

{
    ...
    "iron shot",
    200,
    new calcdice_calculator<9, 11, 3, 4>,
...

{
    ...
    "shard of ice",
    100,
    new calcdice_calculator<3, 5, 1, 2>,
...

{
    ...
    "rocky blast",
    25,
    new dicedef_calculator<2, 3, 1, 3>,
