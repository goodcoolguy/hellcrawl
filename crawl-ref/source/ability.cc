...
struct ability_def
{
    ...
    map<stat_type, int> stat_requirements; // + map of required stats to use the ability
...
static const ability_def Ability_List[] =
{
    ...
    { ABIL_BLINK, "Blink", 0, 50, {}, 0, {FAIL_XL, -1}, abflag::NONE },
    // ^ failure special-cased

    { ABIL_BREATHE_FIRE, "Breathe Fire",
        0, 0, {}, 0, {FAIL_XL, 30, 1}, abflag::BREATH },
    ...
    { ABIL_BREATHE_STEAM, "Breathe Steam",
      0, 0, {}, 0, {FAIL_XL, 20, 1}, abflag::BREATH },
    { ABIL_TRAN_BAT, "Bat Form", 2, 0, {}, 0, {FAIL_XL, 45, 2}, abflag::NONE },

    { ABIL_BREATHE_ACID, "Breathe Acid",
      0, 0, {}, 0, {FAIL_XL, 30, 1}, abflag::BREATH },

    { ABIL_FLY, "Fly", 3, 0, {}, 0, {FAIL_XL, 42, 3}, abflag::NONE },
    { ABIL_STOP_FLYING, "Stop Flying", 0, 0, {}, 0, {}, abflag::NONE },
    { ABIL_DAMNATION, "Hurl Damnation",
        0, 150, {}, 0, {FAIL_XL, 50, 1}, abflag::NONE },
    ...
    { ABIL_FIREBALL, "Fireball", 4, 0, {{STAT_ELEMENTAL, 1}}, 0, {FAIL_XL, -1}, abflag::NONE },
    { ABIL_RECHARGING, "Device Recharging",
      1, 0, {}, 0, {FAIL_XL, 45, 2}, abflag::PERMANENT_MP },

    { ABIL_EVOKE_BERSERK, "Evoke Berserk Rage",
      0, 0, {}, 0, {FAIL_EVO, 50, 2}, abflag::NONE },

    { ABIL_EVOKE_TURN_INVISIBLE, "Evoke Invisibility",
      2, 0, {}, 0, {FAIL_EVO, 60, 2}, abflag::NONE },
    { ABIL_EVOKE_TURN_VISIBLE, "Turn Visible", 0, 0, {}, 0, {}, abflag::NONE },
    { ABIL_EVOKE_FLIGHT, "Evoke Flight",
      1, 0, {}, 0, {FAIL_EVO, 40, 2}, abflag::NONE },
    { ABIL_EVOKE_FOG, "Evoke Fog",
      2, 0, {}, 0, {FAIL_EVO, 50, 2}, abflag::NONE },
    ...
    { ABIL_YRED_INJURY_MIRROR, "Injury Mirror",
      0, 0, {}, 0, {FAIL_INVO, 40, 4, 20}, abflag::PIETY },
    { ABIL_YRED_ANIMATE_REMAINS, "Animate Remains",
      2, 0, {}, 0, {FAIL_INVO, 40, 4, 20}, abflag::NONE },
    { ABIL_YRED_RECALL_UNDEAD_SLAVES, "Recall Enslaved Soul",
      2, 0, {}, 0, {FAIL_INVO, 50, 4, 20}, abflag::NONE },
    { ABIL_YRED_ENSLAVE_SOUL, "Enslave Soul",
      4, 0, {}, 4, {FAIL_INVO, 50, 4, 25}, abflag::NONE },
    { ABIL_YRED_TRANSFERENCE, "Soul Transfer",
        4, 0, {}, 4, {FAIL_INVO, 40, 5, 20}, abflag::NONE },
    { ABIL_YRED_ANIMATE_DEAD, "Animate Dead",
      2, 0, {}, 0, {FAIL_INVO, 40, 4, 20}, abflag::NONE },
    { ABIL_YRED_DRAIN_LIFE, "Drain Life",
      6, 0, {}, 4, {FAIL_INVO, 60, 4, 25}, abflag::NONE },


    // Okawaru
    { ABIL_OKAWARU_HEROISM, "Heroism",
      2, 0, {}, 3, {FAIL_INVO, 30, 6, 20}, abflag::NONE },
    { ABIL_OKAWARU_FINESSE, "Finesse",
      5, 0, {}, 5, {FAIL_INVO, 60, 4, 25}, abflag::NONE },

    // Makhleb
    { ABIL_MAKHLEB_MINOR_DESTRUCTION, "Minor Destruction",
      0, scaling_cost::fixed(1), {}, 0, {FAIL_INVO, 40, 5, 20}, abflag::NONE },
    { ABIL_MAKHLEB_LESSER_SERVANT_OF_MAKHLEB, "Lesser Servant of Makhleb",
      0, scaling_cost::fixed(5), {}, 3, {FAIL_INVO, 40, 5, 20}, abflag::HOSTILE },
    { ABIL_MAKHLEB_HURL_DAMNATION, "Hurl Damnation",
      0, scaling_cost::fixed(10), {}, 5, {FAIL_INVO, 70, 4, 25}, abflag::NONE },
    ...
    { ABIL_DITHMENOS_SHADOW_STEP, "Shadow Step",
      4, 0, {}, 5, {FAIL_INVO, 30, 6, 20}, abflag::NONE },
    { ABIL_DITHMENOS_SHADOW_FORM, "Shadow Form",
      9, 0, {}, 12, {FAIL_INVO, 80, 4, 25}, abflag::SKILL_DRAIN },
    ...
    { ABIL_RU_POWER_LEAP, "Power Leap",
      5, 0, {}, 0, {FAIL_INVO}, abflag::EXHAUSTION },
    { ABIL_RU_APOCALYPSE, "Apocalypse",
      8, 0, {}, 0, {FAIL_INVO}, abflag::EXHAUSTION|abflag::SKILL_DRAIN },

    { ABIL_RU_SACRIFICE_PURITY, "Sacrifice Purity",
      0, 0, {}, 0, {FAIL_INVO}, abflag::SACRIFICE },
    ...
    { ABIL_QAZLAL_UPHEAVAL, "Upheaval",
      4, 0, {}, 3, {FAIL_INVO, 40, 5, 20}, abflag::NONE },
    { ABIL_QAZLAL_CLOUD_SURGE, "Cloud Surge",
      6, 0, {}, 5, {FAIL_INVO, 50, 5, 20}, abflag::NONE },
    { ABIL_QAZLAL_DISASTER_AREA, "Disaster Area",
      7, 0, {}, 8, {FAIL_INVO, 70, 4, 25}, abflag::NONE },
    ...
    { ABIL_WU_JIAN_SERPENTS_LASH, "Serpent's Lash",
        0, 0, {}, 2, {FAIL_INVO}, abflag::EXHAUSTION | abflag::INSTANT },
    { ABIL_WU_JIAN_HEAVENLY_STORM, "Heavenly Storm",
        0, 0, {}, 20, {FAIL_INVO, piety_breakpoint(5), 0, 1}, abflag::NONE },		
		
    { ABIL_STOP_RECALL, "Stop Recall", 0, 0, {}, 0, {FAIL_INVO}, abflag::NONE },
    { ABIL_WU_JIAN_LUNGE, "Lunge", 0, 0, {}, 0, {}, abflag::NONE },
    { ABIL_WU_JIAN_WHIRLWIND, "Whirlwind", 0, 0, {}, 0, {}, abflag::NONE },
    { ABIL_WU_JIAN_WALLJUMP, "Wall Jump", 0, 0, {}, 0, {}, abflag::NONE },
...
bool activate_talent(const talent& tal)
{
    ...
    // all abilities don't need a hunger check.
...
static spret_type _do_ability(const ability_def& abil, bool fail)
{
    ...
    case ABIL_FIREBALL:
        return cast_fireball(&you, you.stat(STAT_ELEMENTAL), fail);
...
{
    map<stat_type, int> stat_requirements = get_ability_def(ability).stat_requirements;
    std::map<stat_type, int>::iterator it = stat_requirements.begin();
    while (it != stat_requirements.end())
    {
		if(you.stat(it->first) < it->second)
            return false;
	    it++;
    }
    return true;
                        ...
                        bool check_confused)
{
    ...
    if (t.which != ABIL_NON_ABILITY && meets_stat_requirements(ability))
        vec.push_back(t);
}
...
vector<talent> your_talents(bool check_confused, bool include_unusable)
{
    ...
    if (you.scan_artefacts(ARTP_FIREBALL))
    {
		_add_talent(talents, ABIL_FIREBALL, check_confused);
    }
