...
const vector<god_power> god_powers[NUM_GODS] =
{
    ...
    { { 1, "gain health from killing" },
      ...
      { 4, ABIL_MAKHLEB_HURL_DAMNATION, "hurl Makhleb's damnation" },
    ...
    // Qazlal
    {
      ...
      { 3, ABIL_QAZLAL_CLOUD_SURGE, "call forth a surge of long-lasting clouds" },
...
{
    return piety + (you.faith() * div_rand_round(piety, 5));
}
...
{
    for (int sk = SK_FIRST_MAGIC_SCHOOL; sk <= SK_LAST_MAGIC; ++sk)
