...
// AXED_MON(MONS_MOTHER_IN_LAW)
	...
	AXED_MON(MONS_SKY_BEAST)
	AXED_MON(MONS_RED_DEVIL)
	AXED_MON(MONS_KRAKEN)
	AXED_MON(MONS_KRAKEN_TENTACLE)
	AXED_MON(MONS_KRAKEN_TENTACLE_SEGMENT)
	AXED_MON(MONS_IRON_GOLEM)
	AXED_MON(MONS_INSUBSTANTIAL_WISP)
	AXED_MON(MONS_MOTTLED_DRACONIAN)
	AXED_MON(MONS_DRACONIAN_ZEALOT)
	AXED_MON(MONS_HILL_GIANT)
	AXED_MON(MONS_DEEP_DWARF)
	AXED_MON(MONS_LEOPARD_GECKO)
	AXED_MON(MONS_RIVER_RAT)
	AXED_MON(MONS_NECROPHAGE)
	AXED_MON(MONS_BLACK_DRACONIAN)
	AXED_MON(MONS_YELLOW_DRACONIAN)
	AXED_MON(MONS_PURPLE_DRACONIAN)
	AXED_MON(MONS_RED_DRACONIAN)
	AXED_MON(MONS_WHITE_DRACONIAN)
	AXED_MON(MONS_GREY_DRACONIAN)
	AXED_MON(MONS_GREEN_DRACONIAN)
	AXED_MON(MONS_PALE_DRACONIAN)
	AXED_MON(MONS_DRACONIAN_ANNIHILATOR)
	AXED_MON(MONS_DRACONIAN_KNIGHT)
	AXED_MON(MONS_DRACONIAN_MONK)
	AXED_MON(MONS_DRACONIAN_SCORCHER)
...

{
    ...
    { {AT_STING, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    13, 715,
...

{
    ...
    { {AT_STING, AF_PLAIN, 14}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    6, 330,
...
{
    MONS_CAUSTIC_SHRIKE, 'b', LIGHTGREEN, "acid robin",
...
{
    MONS_SHARD_SHRIKE, 'b', LIGHTBLUE, "cool robin",
    M_SEE_INVIS | M_UNBLINDABLE | M_WARM_BLOOD | M_FLIES,
    mrd(MR_RES_COLD, 2),
...
{
    MONS_GHOST_ROBIN, 'b', LIGHTMAGENTA, "ghost robin",
    M_SEE_INVIS | M_UNBLINDABLE | M_WARM_BLOOD | M_FLIES,
    MR_RES_COLD,
    12, MONS_GHOST_ROBIN, MONS_GHOST_ROBIN, MH_UNDEAD, 80,
    { {AT_CLAW, AF_PAIN, 30}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    18, 1080,
    8, 18, MST_GHOST_ROBIN, CE_NOCORPSE, S_SCREECH,
    I_HUMAN, HT_LAND, 20, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_TINY, MON_SHAPE_BIRD,
    {TILEP_MONS_GHOST_ROBIN}, TILE_ERROR
},

{
    MONS_DIESEL_ROBIN, 'b', LIGHTRED, "diesel robin",
    M_SEE_INVIS | M_UNBLINDABLE | M_WARM_BLOOD | M_FLIES,
    MR_RES_FIRE,
    12, MONS_DIESEL_ROBIN, MONS_DIESEL_ROBIN, MH_NATURAL, 80,
    { {AT_CLAW, AF_FIRE, 38}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    18, 1300,
    12, 16, MST_NO_SPELLS, CE_NOCORPSE, S_SCREECH,
    I_HUMAN, HT_LAND, 20, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_TINY, MON_SHAPE_BIRD,
    {TILEP_MONS_DIESEL_ROBIN}, TILE_ERROR
},
...

{
    ...
    9, 405,
    2, 11, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    11, 495,
    4, 12, MST_DEEP_ELF_HIGH_PRIEST, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    12, 540,
    2, 11, MST_DEEP_ELF_DEMONOLOGIST, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 17}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 675,
    2, 11, MST_ANNIHILATOR, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 17}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    14, 630,
    2, 11, MST_DEEP_ELF_SORCERER, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 17}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 675,
    2, 11, MST_DEEP_ELF_DEATH_MAGE, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 17}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    14, 730,
    2, 11, MST_DEEP_ELF_ELEMENTALIST, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...
{
    MONS_ANTIMATTER_ELF, 'e', ETC_GOLD, "antimatter elf",
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    8, MONS_ELF, MONS_ELF, MH_NATURAL | MH_EVIL, 120,
    { {AT_HIT, AF_VULN, 30}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    29, 1100,
    2, 17, MST_ANTIMATTER_ELF, CE_NOCORPSE, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_ANTIMATTER_ELF}, TILE_ERROR
},
...

{
    ...
    { {AT_HIT, AF_PLAIN, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 195,
    4, 9, MST_GNOLL_SHAMAN, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    4, 260,
    7, 7, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...
// spriggans ('i')
{
    ...
    { {AT_HIT, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    7, 245,
    3, 18, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
...

{
    ...
    11, 440,
    3, 18, MST_SPRIGGAN_DRUID, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, MOVE_ENERGY(6),
    MONUSE_WEAPONS_ARMOUR, SIZE_LITTLE, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 27}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    12, 540,
    4, 16, MST_SPRIGGAN_BERSERKER, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, MOVE_ENERGY(6),
    MONUSE_WEAPONS_ARMOUR, SIZE_LITTLE, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 16}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    14, 490,
    3, 22, MST_SPRIGGAN_AIR_MAGE, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, MOVE_ENERGY(6),
    MONUSE_WEAPONS_ARMOUR, SIZE_LITTLE, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 30}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 675,
    5, 22, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 16, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_LITTLE, MON_SHAPE_HUMANOID,
...

{
    ...
    M_COLD_BLOOD,
    MR_NO_FLAGS,
    10, MONS_GIANT_LIZARD, MONS_IGUANA, MH_NATURAL, 10,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 21}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    14, 630,
    4, 12, MST_MERFOLK_AQUAMANCER, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_AMPHIBIOUS, 10, SWIM_ENERGY(6),
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 150,
    3, 12, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    3, 150,
    3, 10, MST_ORC_PRIEST, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    4, 280,
    8, 10, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 25}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    9, 675,
    11, 10, MST_ORC_KNIGHT, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 11}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    9, 315,
    6, 11, MST_ORC_SORCERER, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    11, 550,
    3, 10, MST_ORC_HIGH_PRIEST, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 26}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 650,
    9, 8, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    10, 800,
    10, 9, MST_DEATH_KNIGHT, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    8, 520,
    6, 12, MST_VAULT_SENTINEL, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    16, 880,
    10, 10, MST_VAULT_WARDEN, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    9, 495,
    5, 9, MST_IRONBRAND_CONVOKER, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_VULN, 30}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    16, 750,
    7, 15, MST_IMPERIAL_MYRMIDON, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 12, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 16}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    12, 800,
    3, 12, MST_SERVANT_OF_WHISPERS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    12, 1200,
    2, 10, MST_RAGGED_HIEROPHANT, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 25}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    14, 1120,
    4, 5, MST_IRONHEART_PRESERVER, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_KLOWN, 30}, {AT_HIT, AF_KLOWN, 30}, AT_NO_ATK, AT_NO_ATK },
    20, 1500,
    10, 15, MST_PHANTASMAL_WARRIOR, CE_CLEAN, S_SHOUT,
...

{
    ...
    M_WARM_BLOOD,
    MR_NO_FLAGS,
    16, MONS_QUOKKA, MONS_QUOKKA, MH_NATURAL, 0,
    { {AT_BITE, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    1, 55,
    1, 13, MST_NO_SPELLS, CE_CLEAN, S_SILENT,
    I_ANIMAL, HT_LAND, 12, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_LITTLE, MON_SHAPE_QUADRUPED,
...

{
    ...
    { {AT_STING, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    4, 180,
...

{
    ...
    { {AT_STING, AF_PLAIN, 30}, {AT_CLAW, AF_PLAIN, 15},
...

{
    ...
    { {AT_HIT, AF_PLAIN, 25}, {AT_BITE, AF_PLAIN, 15}, AT_NO_ATK,
       AT_NO_ATK },
    11, 550,
...

{
    ...
    MR_RES_ELEC | MR_RES_COLD | MR_RES_FIRE,
...

{
    ...
    M_NO_SKELETON,
    mrd(MR_RES_ELEC, 3) | MR_NO_FLAGS,
    20, MONS_SPIDER, MONS_ORB_SPIDER, MH_NATURAL, 40,
    { {AT_BITE, AF_ELEC, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    6, 420,
...

{
    ...
    M_NO_SKELETON,
    mrd(MR_RES_NEG, 3) | MR_RES_ROTTING,
...
{
    MONS_PLUTONIUM_CRAB, 't', LIGHTGREEN, "plutonium crab",
    M_NO_SKELETON,
    MR_RES_FIRE,
    25, MONS_CRAB, MONS_PLUTONIUM_CRAB, MH_NATURAL, 40,
    { {AT_BITE, AF_CONTAM, 30}, {AT_CLAW, AF_FIRE, 15}, {AT_CLAW, AF_FIRE, 15}, AT_NO_ATK },
    12, 1220,
    12, 6, MST_PLUTONIUM_CRAB, CE_MUTAGEN, S_SILENT,
    I_ANIMAL, HT_AMPHIBIOUS, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_SMALL, MON_SHAPE_QUADRUPED,
    {TILEP_MONS_PLUTONIUM_CRAB}, TILE_CORPSE_PLUTONIUM_CRAB
},
...
// worms and slugs ('w')
DUMMY(MONS_WORM, 'w', LIGHTRED, "worm", TILEP_MONS_WORM)
...

{
    ...
    4, 220,
    5, 14, MST_NO_SPELLS, CE_NOXIOUS, S_BUZZ,
    I_ANIMAL, HT_LAND, 15, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_TINY, MON_SHAPE_INSECT_WINGED,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 14}, {AT_STING, AF_PLAIN, 12}, AT_NO_ATK, AT_NO_ATK },
    7, 245,
...

{
    ...
    { {AT_HIT, AF_DRAIN_STAT, 22}, {AT_HIT, AF_DRAIN_STAT, 14},
      {AT_STING, AF_PLAIN, 12}, AT_NO_ATK },
    13, 715,
...
// corporeal (semi-)humanoid undead ('z')
{
    ...
    3, 165,
    6, 8, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 32}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    14, 700,
    24, 7, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...
// angelic beings ('A')
{
    ...
    { {AT_HIT, AF_PLAIN, 25}, {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK,
       AT_NO_ATK },
    12, 1020,
    12, 20, MST_ANGEL, CE_NOCORPSE, S_SHOUT,
    I_HUMAN, HT_LAND, 15, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 15}, {AT_CHERUB, AF_PLAIN, 8}, AT_NO_ATK,
       AT_NO_ATK },
    9, 765,
    12, 20, MST_BATTLECRY, CE_NOCORPSE, S_CHERUB,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM,
        MON_SHAPE_HUMANOID_WINGED,
...

{
    ...
    MR_NO_FLAGS,
    10, MONS_BEETLE, MONS_DEATH_SCARAB, MH_UNDEAD, 60,
...

{
    ...
    { {AT_HIT, AF_CLEAVE, 100}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    20, 1700,
    20, 5, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 15, ATTACK_ENERGY(20),
    MONUSE_OPEN_DOORS, SIZE_GIANT, MON_SHAPE_HUMANOID,
...
{
    MONS_GIANT_GIANT, 'C', LIGHTRED, "giant giant",
    M_WARM_BLOOD | M_SPEAKS | M_FIGHTER | M_SEE_INVIS,
    MR_NO_FLAGS,
    9, MONS_GIANT, MONS_GIANT_GIANT, MH_NATURAL, 100,
    { {AT_HIT, AF_PLAIN, 60}, {AT_CONSTRICT, AF_CRUSH, 9}, AT_NO_ATK, AT_NO_ATK },
    18, 2400,
    10, 1, MST_GIANT_GIANT, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_GIANT, MON_SHAPE_HUMANOID,
    {TILEP_MONS_GIANT_GIANT}, TILE_CORPSE_GIANT_GIANT
},
...
{
    MONS_FIRE_DRAGON, 'D', RED, "fire dragon",
    M_WARM_BLOOD | M_FLIES,
...

{
    ...
    mrd(MR_RES_COLD, 2) | mrd(MR_RES_NEG, 3),
...
{
    MONS_THE_GIAGGOSTUONO, 'D', LIGHTRED, "THE GIAGGOSTUONO",
    M_SEE_INVIS | M_WARM_BLOOD,
    mrd(MR_RES_FIRE, 2),
    10, MONS_DRAGON, MONS_THE_GIAGGOSTUONO, MH_NATURAL, 180,
    { {AT_TRAMPLE, AF_TRAMPLE, 80}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    24, 1750,
    34, 6, MST_THE_GIAGGOSTUONO, CE_NOXIOUS, S_LOUD_ROAR,
    I_ANIMAL, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_GIANT, MON_SHAPE_QUADRUPED_WINGED,
    {TILEP_MONS_THE_GIAGGOSTUONO}, TILE_CORPSE_THE_GIAGGOSTUONO
},
...

{
    ...
    { {AT_STING, AF_PLAIN, 26}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    7, 385,
...
// dummy for recolouring
{
    MONS_FROGTAUR, 'F', LIGHTCYAN, "frogtaur",
    M_SPEAKS | M_NO_POLY_TO,
    MR_NO_FLAGS,
    10, MONS_FROG, MONS_FROGTAUR, MH_NATURAL, 10,
    { {AT_HIT, AF_PLAIN, 6}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 180,
...

{
    ...
    MR_RES_COLD | MR_VUL_FIRE | MR_RES_ELEC
        | mrd(MR_RES_ACID, 3),
...

{
    ...
    { {AT_HIT, AF_DRAIN_SPEED, 32}, {AT_HIT, AF_ROT, 32}, AT_NO_ATK, AT_NO_ATK },
    11, 495,
...
{
    MONS_MUTATATOTOT, 'J', YELLOW, "mutatatotot",
    M_UNBLINDABLE | M_NO_POLY_TO,
    mrd(MR_RES_ACID, 3),
    10, MONS_JELLY, MONS_MUTATATOTOT, MH_NATURAL, 60,
    { {AT_HIT, AF_ACID, 40}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    14, 930,
    0, 4, MST_MUTATATOTOT, CE_NOCORPSE, S_SILENT,
    I_BRAINLESS, HT_AMPHIBIOUS, 12, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_SMALL, MON_SHAPE_BLOB,
    {TILEP_MONS_MUTATATOTOT}, TILE_ERROR
},
...

{
    ...
    { {AT_HIT, AF_PLAIN, 8}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    6, 390,
    4, 13, MST_KOBOLD_DEMONOLOGIST, CE_NOXIOUS, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_SMALL, MON_SHAPE_HUMANOID,
...

{
    ...
    M_SEE_INVIS | M_SPEAKS,
    mrd(MR_RES_COLD, 2),
    12, MONS_REVENANT, MONS_REVENANT, MH_UNDEAD, MAG_IMMUNE,
    { {AT_HIT, AF_PLAIN, 26}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    18, 810,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 14}, {AT_CONSTRICT, AF_CRUSH, 4},
       AT_NO_ATK, AT_NO_ATK },
    8, 600,
    8, 10, MST_NAGA_RITUALIST, CE_NOXIOUS, S_SHOUT,
    I_HUMAN, HT_LAND, 10, MOVE_ENERGY(14),
    MONUSE_WEAPONS_ARMOUR, SIZE_LARGE, MON_SHAPE_NAGA,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 27}, {AT_CONSTRICT, AF_CRUSH, 7},
       AT_NO_ATK, AT_NO_ATK },
    15, 825,
    8, 10, MST_NAGA_MAGE, CE_NOXIOUS, S_SHOUT,
    I_HUMAN, HT_LAND, 10, MOVE_ENERGY(14),
    MONUSE_WEAPONS_ARMOUR, SIZE_LARGE, MON_SHAPE_NAGA,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 16}, {AT_PECK, AF_PLAIN, 8}, {AT_CLAW, AF_PLAIN, 8},
       AT_NO_ATK },
    10, 600,
    6, 16, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, MOVE_ENERGY(9),
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...
{
	MONS_ELEVENGU, 'Q', LIGHTGREEN, "elevengu",
    M_FIGHTER | M_SEE_INVIS | M_WARM_BLOOD | M_SPEAKS | M_HYBRID | M_FLIES,
    MR_NO_FLAGS,
    13, MONS_TENGU, MONS_ELEVENGU, MH_NATURAL, 60,
    { {AT_HIT, AF_PLAIN, 40}, {AT_PECK, AF_PLAIN, 16}, {AT_CLAW, AF_PLAIN, 16},
       AT_NO_ATK },
    19, 1480,
    2, 17, MST_ELEVENGU, CE_NOCORPSE, S_SHOUT,
    I_HUMAN, HT_LAND, 10, MOVE_ENERGY(9),
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_ELEVENGU}, TILE_ERROR
},
...

{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    11, 660,
    8, 14, MST_RAKSHASA, CE_NOCORPSE, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_BITE, AF_PLAIN, 24}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 650,
    2, 15, MST_NO_SPELLS, CE_NOXIOUS, S_HISS,
...
{
    MONS_SUBTRACTOR_SNAKE, 'S', LIGHTRED, "subtractor snake",
    M_SEE_INVIS | M_COLD_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    10, MONS_GUARDIAN_SERPENT, MONS_SUBTRACTOR_SNAKE, MH_NATURAL, 80,
    { {AT_BITE, AF_ACID, 24}, {AT_BITE, AF_ACID, 24}, {AT_BITE, AF_PLAIN, 24}, AT_NO_ATK },
    15, 940,
    7, 23, MST_SUBTRACTOR_SNAKE, CE_MUTAGEN, S_HISS,
    I_HUMAN, HT_LAND, 18, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_LARGE, MON_SHAPE_SNAKE,
    {TILEP_MONS_SUBTRACTOR_SNAKE}, TILE_CORPSE_SUBTRACTOR_SNAKE
},
...

{
    ...
    { {AT_HIT, AF_PLAIN, 33}, {AT_BITE, AF_VAMPIRIC, 15}, AT_NO_ATK,
       AT_NO_ATK },
    11, 715,
    19, 7, MST_VAMPIRE_KNIGHT, CE_NOCORPSE, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 15}, {AT_BITE, AF_VAMPIRIC, 15}, AT_NO_ATK,
       AT_NO_ATK },
    10, 550,
    12, 10, MST_VAMPIRE_MAGE, CE_NOCORPSE, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...
// dangerous, but still come out at 200+ XP
{
    ...
    { {AT_HIT, AF_WEAKNESS, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    7, 385,
    3, 13, MST_PHANTASMAL_WARRIOR, CE_NOCORPSE, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...
{
    MONS_HUNGRY_GHOST, 'W', GREEN, "angry ghost",
    M_SEE_INVIS | M_INSUBSTANTIAL | M_SPEAKS | M_FLIES,
    mrd(MR_RES_COLD, 2),
    8, MONS_PHANTOM, MONS_HUNGRY_GHOST, MH_UNDEAD, 40,
    { {AT_HIT, AF_RAGE, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    7, 385,
    0, 12, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    M_SEE_INVIS | M_INSUBSTANTIAL | M_INVIS | M_FLIES,
    mrd(MR_RES_COLD, 3),
...

{
    ...
    mrd(MR_RES_COLD, 3),
    6, MONS_WRAITH, MONS_SILENT_SPECTRE, MH_UNDEAD, 40,
    { {AT_HIT, AF_ANTIMAGIC, 25}, {AT_HIT, AF_ANTIMAGIC, 25}, AT_NO_ATK, AT_NO_ATK },
    13, 600,
    5, 15, MST_SILENT_SPECTRE, CE_NOCORPSE, S_SILENT,
    I_HUMAN, HT_LAND, 16, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    M_SEE_INVIS | M_INSUBSTANTIAL | M_FLIES,
    MR_RES_COLD,
    10, MONS_WRAITH, MONS_EIDOLON, MH_UNDEAD, 140,
...

{
    ...
    M_SEE_INVIS,
    MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC,
    7, MONS_TENTACLED_MONSTROSITY, MONS_TENTACLED_MONSTROSITY,
        MH_DEMONIC, 160,
...
{
    MONS_DEV_FAVORITE, 'X', LIGHTBLUE, "Orb Child",
    M_SEE_INVIS | M_NO_POLY_TO,
    MR_RES_COLD | MR_RES_ACID,
    15, MONS_ORB_GUARDIAN, MONS_DEV_FAVORITE, MH_NATURAL, 120,
    { {AT_HIT, AF_COLD, 45}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    15, 825,
    13, 13, MST_DEV_FAVORITE, CE_NOCORPSE, S_SILENT,
    I_HUMAN, HT_LAND, 14, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_GIANT, MON_SHAPE_MISC,
    {TILEP_MONS_DEV_FAVORITE}, TILE_ERROR
},
...
// eels
{
    ...
    { {AT_CONSTRICT, AF_CRUSH, 7}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 165,
...

{
    ...
    10, 650,
    7, 7, MST_SALAMANDER_MYSTIC, CE_CLEAN, S_SILENT,
    I_HUMAN, HT_AMPHIBIOUS_LAVA, 10, SWIM_ENERGY(7),
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_NAGA,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 550,
    12, 10, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 500,
    9, 11, MST_NO_SPELLS, CE_NOXIOUS, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 500,
    9, 11, MST_NO_SPELLS, CE_CLEAN, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...
// minor demons: imps, etc. ('5')
{
    ...
    { {AT_HIT, AF_PLAIN, 4}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 160,
    3, 14, MST_NO_SPELLS, CE_NOCORPSE, S_SHOUT,
    I_HUMAN, HT_LAND, 12, DEFAULT_ENERGY,
...
// middle demons ('3')
{
    ...
    M_SEE_INVIS | M_FLIES,
    MR_RES_ELEC | MR_VUL_COLD | mrd(MR_RES_FIRE, 3)
        | MR_VUL_WATER,
...

{
    ...
    M_SEE_INVIS | M_FLIES,
    MR_VUL_FIRE | mrd(MR_RES_COLD, 2) | mrd(MR_RES_ELEC, 3),
...

{
    ...
    { {AT_HIT, AF_REACH, 55}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    14, 770,
    15, 10, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_STARTING_EQUIPMENT, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    M_SEE_INVIS | M_INVIS,
    MR_RES_COLD | MR_RES_FIRE | MR_RES_ELEC,
    14, MONS_LOROCYPROCA, MONS_LOROCYPROCA, MH_DEMONIC, 140,
    { {AT_HIT, AF_ANTIMAGIC, 35}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    14, 770,
...
// fiends, etc. ('1')
{
    ...
    M_SEE_INVIS | M_FLIES,
    MR_RES_DAMNATION | mrd(MR_RES_FIRE, 3) | MR_VUL_COLD
        | MR_VUL_WATER,
...
{
    MONS_TZITZIMITL, '1', MAGENTA, "Shadow Fiend",
    M_SEE_INVIS | M_FLIES,
...

{
    ...
    M_FIGHTER | M_SEE_INVIS,
    MR_RES_ELEC | MR_RES_FIRE | MR_RES_COLD | MR_NO_FLAGS,
...
{
    MONS_ZOTLING, '8', LIGHTRED, "zotling",
    M_NO_FLAGS,
    MR_NO_FLAGS,
    6, MONS_GOLEM, MONS_ZOTLING, MH_NONLIVING, MAG_IMMUNE,
    { {AT_HIT, AF_VAMPIRIC, 40}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    8, 920,
    15, 5, MST_NO_SPELLS, CE_NOCORPSE, S_SILENT,
    I_BRAINLESS, HT_LAND, 13, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_SMALL, MON_SHAPE_HUMANOID,
    {TILEP_MONS_ZOTLING}, TILE_ERROR
},
...
{
    MONS_ZOTBOT, '8', ETC_MAGIC, "zotbot",
    M_SEE_INVIS | M_SPEAKS,
    MR_RES_FIRE | MR_RES_COLD | MR_RES_DAMNATION,
    10, MONS_GOLEM, MONS_ZOTBOT, MH_NONLIVING, MAG_IMMUNE,
    { {AT_HIT, AF_PLAIN, 35}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    21, 1010,
    15, 9, MST_ZOTBOT, CE_NOCORPSE, S_SILENT,
    I_BRAINLESS, HT_LAND, 13, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_LARGE, MON_SHAPE_HUMANOID,
    {TILEP_MONS_ZOTBOT}, TILE_ERROR
},
...
//'b'irds
{
    MONS_COMBO_ROBIN, 'b', LIGHTCYAN, "the Combo Robin",
    M_UNIQUE | M_SEE_INVIS | M_UNBLINDABLE | M_WARM_BLOOD | M_FLIES,
    MR_RES_FIRE | MR_RES_COLD | MR_RES_ACID | MR_RES_NEG | MR_NO_FLAGS,
    15, MONS_DIESEL_ROBIN, MONS_DIESEL_ROBIN, MH_NATURAL, 120,
    { {AT_CLAW, AF_ACID, 30}, {AT_CLAW, AF_FIRE, 30}, {AT_CLAW, AF_COLD, 30}, AT_NO_ATK },
    22, 2000,
    10, 22, MST_GHOST_ROBIN, CE_NOCORPSE, S_SCREECH,
    I_HUMAN, HT_LAND, 20, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_TINY, MON_SHAPE_BIRD,
    {TILEP_MONS_COMBO_ROBIN}, TILE_ERROR
},
...

{
    ...
    mrd(MR_RES_ELEC, 3) | MR_RES_COLD | MR_NO_FLAGS,
...

{
    ...
    MR_RES_DAMNATION | mrd(MR_RES_FIRE, 3),
...
{
    MONS_ROBIN, 'g', LIGHTCYAN, "Samantha",
...
// Semi-unique in the moon base wizlab
{
    ...
    MR_RES_FIRE | MR_RES_COLD | MR_NO_FLAGS,
...

{
    ...
    { {AT_HIT, AF_REACH, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 300,
...

{
    ...
    MR_RES_FIRE | mrd(MR_RES_COLD | MR_RES_ELEC, 3),
...

{
    ...
    mrd(MR_RES_ELEC | MR_RES_FIRE, 3) | MR_RES_DAMNATION
        | MR_RES_COLD,
...

{
    ...
    M_UNIQUE | M_FIGHTER | M_SEE_INVIS | M_SPEAKS | M_MALE | M_FLIES | M_TALL_TILE,
    MR_RES_ELEC | MR_RES_DAMNATION | mrd(MR_RES_FIRE, 3),
