...
enum attribute_type
{
    ...
    ATTR_GOLD_GENERATED,       // Count gold generated on permanent levels this game.
#if TAG_MAJOR_VERSION == 34
...
enum branch_type                // you.where_are_you
{
    BRANCH_DUNGEON,
    BRANCH_ORC,
    BRANCH_FIRST_NON_DUNGEON = BRANCH_ORC,
    BRANCH_ELF,
    BRANCH_SWAMP,
    BRANCH_SHOALS,
    BRANCH_SNAKE,
...
enum equipment_type
{
    ...
    EQ_BODY_ARMOUR,
    EQ_FIRST_JEWELLERY,
    EQ_AMULET = EQ_FIRST_JEWELLERY,
    EQ_LAST_JEWELLERY = EQ_AMULET,
    NUM_EQUIP,
...
#endif
    MONS_LAST_DRACONIAN = MONS_DRACONIAN,
