...
void update_vision_range()
{
    ...
    // Daywalker gives +1
    if (you.get_mutation_level(MUT_DAYWALKER))
    {
...
int player_mp_regen()
{
    int regen_amount = 14 + you.max_magic_points / 2;
...
int check_stealth()
{
    ...
    if (you.attribute[ATTR_SHADOWS] || you.berserk()
        || you.duration[DUR_CLUMSY] || you.get_mutation_level(MUT_NO_STEALTH))
    {
        return 0;
    }
...
bool napalm_player(int amount, string source, string source_aux)
{
    ...
    if (amount <= 0 || you.duration[DUR_WATER_HOLD] || feat_is_watery(grd(you.pos())))
        return false;
...
void player_end_berserk()
{
    ...
    if (you.berserk_penalty != NO_BERSERK_PENALTY
        && one_chance_in(10 + you.get_mutation_level(MUT_BERSERK) * 25))
    {
