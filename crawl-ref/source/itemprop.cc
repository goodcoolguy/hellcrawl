...
/// brand weights for (formerly) long blades.
...
/**
 * If a monster of the given type is dies, what kind of armour can it leave?
 *
 * @param mc    The class of monster in question.
 * @return      The armour_type of the given monster's armour, or NUM_ARMOURS if
 *              the monster does not leave armour.
 */
...
/**
 * Is the given armour a type that drops from dead monsters (i.e. dragon or troll
 * armour?
 *
